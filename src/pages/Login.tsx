  ...
  return (
    <div className="min-h-[100dvh] overflow-y-auto bg-slate-50 flex flex-col justify-center px-6 py-12">
      ...
      <button 
         ...
         className="mt-6 mx-auto text-[11px] font-medium text-slate-300 hover:text-slate-400 transition-colors focus:outline-none"
      >
        {authMode === 'phone' ? 'Admin / Email Login' : 'Use Phone Number'}
      </button>
    </div>
  );
}
